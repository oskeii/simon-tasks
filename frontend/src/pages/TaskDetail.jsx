...
const TaskDetail = () => {
    ...
    const fetchTask = async () => {
        try {
            ...
            setError(
                'Failed to load task details. The task may have been deleted or you may not have permission...'
            );
        } finally {
            setLoading(false);
        }
    ...
    const deleteTask = async () => {
        if (window.confirm('Are you sure you want to delete this task?')) {
            let delete_subtasks =
                task.has_subtasks && window.confirm('Delete SUBTASKS too?');
