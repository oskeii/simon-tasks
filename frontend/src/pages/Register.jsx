    ...
    <div>
        ...
        {error && <p style={{color: "red"}}>{error}</p>}
            <form id='registration-form' method="POST" onSubmit={handleSubmit} autoComplete='off'> {/* ADD FORM VALIDATION*/}
                ...
                {field_err.username && <span style={{color: "red"}}>{field_err.username}</span>}                    
                </p>
                ...
                {field_err.password && <span style={{color: "red"}}>{field_err.password}</span>}                    
                </p>
                ...
                {field_err.confirm_password && <span style={{color: "red"}}>{field_err.confirm_password}</span>}                    
                </p>
                ...
                {field_err.email && <span style={{color: "red"}}>{field_err.email}</span>}
                <p>
